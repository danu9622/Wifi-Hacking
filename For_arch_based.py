...
print("\n")
cmd0 = os.system("pacman -S install aircrack-ng crunch xterm wordlists reaver pixiewps bully xterm wifite")
...
""")
            ...
            if w == 1 :
                cmd = os.system("sudo pacman -S update && pacman -S install aircrack-ng")
            elif w == 90:
                print("sudo pacman -S update && pacman -S install git && git clone https://github.com/v1s1t0r1sh3r3/airgeddon.git")
            elif w == 91:
                print("sudo pacman -S update && pacman -S install git && git clone https://github.com/derv82/wifite2.git")
            elif w == 2 :
                cmd = os.system("sudo pacman -S update && pacman -S install asleep")
            elif w == 3 :
                cmd = os.system("sudo pacman -S update && pacman -S install bluelog")
            elif w == 4 :
                cmd = os.system("sudo pacman -S update && pacman -S install bluemaho")
            elif w == 5 :
                cmd = os.system("sudo pacman -S update && pacman -S install bluepot")
            elif w == 6 :
                cmd = os.system("sudo pacman -S update && pacman -S install blueranger")
            elif w == 7 :
                cmd = os.system("sudo pacman -S update && pacman -S install bluesnarfer")
            elif w == 8 :
                cmd = os.system("sudo pacman -S update && pacman -S install bully")
            elif w == 9 :
                cmd = os.system("sudo pacman -S update && pacman -S install cowpatty")
            elif w == 10 :
                cmd = os.system("sudo pacman -S update && pacman -S install crackle")
            elif w == 11 :
                cmd = os.system("sudo pacman -S update && pacman -S install eapmd5pass")
            elif w == 12 :
                cmd = os.system("sudo pacman -S update && pacman -S install fern-wifi-cracker")
            elif w == 13 :
                cmd = os.system("sudo pacman -S update && pacman -S install ghost-phisher")
            elif w == 14 :
                cmd = os.system("sudo pacman -S update && pacman -S install giskismet")
            elif w == 15 :
                cmd = os.system("pacman -S install git && git clone git://git.kali.org/packages/gr-scan.git")
            elif w == 16 :
                cmd = os.system("sudo pacman -S update && pacman -S install kalibrate-rtl")
            elif w == 17 :
                cmd = os.system("sudo pacman -S update && pacman -S install killerbee-ng")
            elif w == 18 :
                cmd = os.system("sudo pacman -S update && pacman -S install kismet")
            elif w == 19 :
                cmd = os.system("sudo pacman -S update && pacman -S install mdk3")
            elif w == 20 :
                cmd = os.system("sudo pacman -S update && pacman -S install mfcuk")
            elif w == 21 :
                cmd = os.system("sudo pacman -S update && pacman -S install mfoc")
            elif w == 22 :
                cmd = os.system("sudo pacman -S update && pacman -S install mfterm")
            elif w == 23 :
                cmd = os.system("sudo pacman -S update && pacman -S install multimon-ng")
            elif w == 24 :
                cmd = os.system("sudo pacman -S update && pacman -S install pixiewps")
            elif w == 25 :
                cmd = os.system("sudo pacman -S update && pacman -S install reaver")
            elif w == 26 :
                cmd = os.system("sudo pacman -S update && pacman -S install redfang")
            elif w == 27 :
                cmd = os.system("sudo pacman -S update && pacman -S install rtlsdr-scanner")
            elif w == 28 :
                cmd = os.system("sudo pacman -S update && pacman -S install spooftooph")
            elif w == 29 :
                cmd = os.system("sudo pacman -S update && pacman -S install wifi-honey")
            elif w == 30 :
                cmd = os.system("sudo pacman -S update && pacman -S install wifitap")
            elif w == 31 :
                cmd = os.system("sudo pacman -S update && pacman -S install wifite")
            elif w == 32 :
                intro()
            elif w == 0 :
                cmd = os.system("pacman -S install -y aircrack-ng asleap bluelog blueranger bluesnarfer bully cowpatty crackle eapmd5pass fern-wifi-cracker ghost-phisher giskismet gqrx kalibrate-rtl killerbee kismet mdk3 mfcuk mfoc mfterm multimon-ng pixiewps reaver redfang spooftooph wifi-honey wifitap wifite")
            else:
                print("Not Found")
            wire()
        wire()
